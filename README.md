...
## Report
The final [report](https://github.com/berniwal/CIL_Project/blob/master/report/bubblesort-submission.pdf) can be found in the folder `report/bubblesort-submission.pdf`.
...
* Make sure to have put the albert_xxlarge checkpoint files (downloaded from https://storage.googleapis.com/albert_models/albert_xxlarge_v2.tar.gz) unziped in the `'./bert/checkpoints/albert_xxlarge'` folder and set the variable `CHECKPOINT='./bert/checkpoints/albert_xxlarge'` for the `"if MODEL=='albert':'` case.

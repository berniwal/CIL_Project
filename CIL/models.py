...
# Adapted Implementation of http://nlp.seas.harvard.edu/2018/04/03/attention.html
...
class Generator(nn.Module):
    ...
    def __init__(self, decoder_model, vocab):
        super(Generator,self).__init__()
        self.projection = nn.Linear(decoder_model, vocab)

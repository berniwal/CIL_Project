...
class MovieReviewData:
    ...
    def __init__(self, tokenizer= FullTokenizer, sample_size=None, max_seq_len=1024):
        ...
        #train = trainset.head(2500000)
        #test = trainset.head(2500000)
        ...
        if sample_size is not None:
            ...
            train, test = train.head(sample_size), test.head(128)
...
if __name__== "__main__":
    ...
    model.save_weights('./twitter_initial.h5', overwrite=True)